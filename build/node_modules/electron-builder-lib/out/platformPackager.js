...
class PlatformPackager {
  ...
  copyAppFiles(taskManager, asarOptions, resourcePath, defaultDestination, outDir, platformSpecificBuildOptions, excludePatterns, macroExpander) {
    ...
    const _computeFileSets = matchers => {
      return (0, _AppFileCopierHelper().computeFileSets)(matchers, this.info.isPrepackedAppAsar ? null : transformer, this, isElectronCompile).then((() => {
        var _ref2 = (0, _bluebirdLst().coroutine)(function* (result) {
          if (!_this4.info.isPrepackedAppAsar) {
            ...
            result = result.concat((yield (0, _AppFileCopierHelper().copyNodeModules)(_this4, moduleFileMatcher, transformer)));
          }
