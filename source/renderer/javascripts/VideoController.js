...
module.exports = class VideoController {
  ...
  init() {
    ...
    // ビデオをリセット
    document.getElementById('video-area').innerHTML = `<video id="video" controls><source src="${this.filePath}"></video>`;
  ...
  stop() {
    document.getElementById('video-area').innerHTML = '<video id="video"></video>';
  }
  togglePlayStat() {
